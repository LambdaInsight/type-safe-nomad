...
let Region = < us | eu >
let Datacenter = <  us-east-1 | eu-central-1 | eu-west-1 >

let Datacenters = List Datacenter

let Job : Type = { region: Region, datacenters: Datacenters }

let job = { region = Region.us, datacenters = [ Datacenter.us-east-1 ] }
